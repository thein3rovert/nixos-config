...
in
{
  ...
  config = if-jotty-enable {
    ...
    systemd.tmpfiles.rules = [
      ...
      "d ${dataDir}/data/users 0755 1000 1000 -"
      "d ${dataDir}/data/checklists 0755 1000 1000 -"
      "d ${dataDir}/data/notes 0755 1000 1000 -"
      "d ${dataDir}/data/sharing 0755 1000 1000 -"
