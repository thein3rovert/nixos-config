...
{
  options.homeSetup.desktop.aerospace.enable = lib.mkEnableOption "Aerospace tiling window manager";

  config = lib.mkIf config.homeSetup.desktop.aerospace.enable {
    programs.aerospace = {
      enable = true;
